    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#040b1c]">
      ...
      <header className="pointer-events-none absolute inset-x-0 top-0 z-[70] px-4 pt-4 sm:px-12 md:px-16">
        <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          ...
          <div className="logo-container pointer-events-auto absolute left-[11px] top-[-2px] sm:relative sm:left-auto sm:top-auto sm:-translate-x-3 sm:-translate-y-[4.75rem] md:-translate-y-[5.25rem] lg:-translate-y-[5.5rem]">
          ...
          <nav
            className={`pointer-events-auto fixed left-1/2 top-[11rem] flex -translate-x-1/2 gap-1.5 rounded-full bg-[rgba(4,10,24,0.7)] px-2 py-1.5 backdrop-blur-md transition-all duration-700 sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:ml-auto sm:translate-x-0 sm:gap-3 sm:bg-transparent sm:px-2 sm:py-0 sm:-translate-y-[4.5rem] md:-translate-y-[5rem] lg:-translate-y-[5.5rem] ${
          ...
          >
            {[
              ...
              <MovingButton
                key={label}
                borderRadius="1.2rem"
                className="tech-fade-in px-2 py-1 text-[0.45rem] font-semibold uppercase tracking-[0.1em] text-slate-100 transition-all duration-300 hover:scale-[1.05] hover:text-white sm:px-6 sm:py-2 sm:text-xs md:text-sm"
