        ...
        >
          <div className="group/front relative flex h-full w-full flex-col overflow-hidden rounded-[2.25rem] border border-[rgba(255,255,255,0.12)] bg-slate-950/40 shadow-[0_32px_90px_rgba(6,16,38,0.58)]">
            <img
              src={image}
              alt={title}
              className="absolute inset-0 h-full w-full origin-center scale-[0.78] object-cover object-center brightness-[1.08] contrast-[1.05] saturate-[1.28] transition-transform duration-[900ms] ease-out group-hover/front:scale-[0.86]"
            />
